...
from mujoco_playground._src.locomotion_mixed.kawaru import base as kawaru_base
...
def default_config() -> config_dict.ConfigDict:
  return config_dict.create(
      ...
      models_config=config_dict.create(
...
class Joystick(kawaru_base.KawaruEnv):
  ...
  def _maybe_apply_perturbation(self, state: mjx_env.State) -> mjx_env.State:
    ...
    def apply_pert(state: mjx_env.State) -> mjx_env.State:
      ...
      # state.info["data"] = state.info["data"].replace(xfrc_applied=xfrc_applied)
